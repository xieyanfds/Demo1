...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/loginJs/jquery.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/loginJs/verificationNumbers.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/loginJs/Particleground.js"></script>
